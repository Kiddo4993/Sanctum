        ...
        options={{
          ...
          headerLeft: () => (
            <TouchableOpacity onPress={() => router.back()} style={{ marginLeft: SPACING.md }}>
              <Text style={{ color: COLORS.accentPlatinum, fontSize: 16 }}>Back</Text>
            </TouchableOpacity>
          ),
        }}
      />
...
const styles = StyleSheet.create({
  ...
  bubbleMe: { backgroundColor: COLORS.accentPlatinum, borderBottomRightRadius: 4 },
  ...
  sendBtn: { backgroundColor: COLORS.accentPlatinum, width: 40, height: 40, borderRadius: 20, justifyContent: 'center', alignItems: 'center', marginLeft: SPACING.sm, marginBottom: 2 },
